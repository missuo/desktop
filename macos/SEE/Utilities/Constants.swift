...
enum Constants: Sendable {
    static let defaultBaseURL = "https://s.ee/api/v1/"
    static let baseURLKey = "baseURL"
    static let defaultShortLinkDomainKey = "defaultShortLinkDomain"
    static let defaultTextDomainKey = "defaultTextDomain"
